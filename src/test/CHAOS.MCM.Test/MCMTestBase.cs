    ...
    public class MCMTestBase : TestBase
    {
        ...
        public new void SetUp()
        {
            ...
            using( var db = new MCMEntities() )
			{
			    ...
			    ObjectTypeModule = new ObjectTypeModule();
                ObjectTypeModule.Initialize("<Settings ConnectionString=\"metadata=res://*/MCM.csdl|res://*/MCM.ssdl|res://*/MCM.msl;provider=MySql.Data.MySqlClient;provider connection string=&quot;server=10.211.55.9;User Id=Portal;password=GECKONpbvu7000;Persist Security Info=True;database=MCM&quot;\"/>");
