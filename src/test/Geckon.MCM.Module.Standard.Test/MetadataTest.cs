...
namespace Geckon.MCM.Module.Standard.Test
{
    ...
    public class MetadataTest : BaseTest
    {
        ...
        {
            var result = MCMModule.Metadata_Set( AdminCallContext, Object.GUID, MetadataSchema.ID, Afrikaans.LanguageCode, "<demo><title>test</title><abstract>test</abstract><description>test</description></demo>" ) ;
