...
INSERT INTO Object(GUID,ObjectTypeID,DateCreated)VALUES(unhex('00000000000000000000000000000005'),1,'1991-10-02 23:59:59');
...
INSERT INTO MetadataSchema(GUID,Name,SchemaXML,DateCreated)VALUES
(unhex('00000000000000000000000000000200'),'test schema','<xml/>','1990-10-01 23:59:59');

INSERT INTO MetadataSchema_User_Join(MetadataSchemaGUID, UserGUID, Permission, DateCreated)VALUES
(unhex('00000000000000000000000000000200'),unhex('00000000000000000000000000001000'),255,'1991-10-02 23:59:59');
...
INSERT INTO Folder_User_Join(FolderID, UserGUID, Permission, DateCreated) VALUES
(1, unhex('00000000000000000000000000001000'),255,'1990-10-01 23:59:59');
