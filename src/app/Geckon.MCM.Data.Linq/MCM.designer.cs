...
namespace Geckon.MCM.Data.Linq
{
    ...
    partial void DeleteObject_Object_Join(Object_Object_Join instance);
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.MetadataSchema_Get")]
		public ISingleResult<MetadataSchema> MetadataSchema_Get([global::System.Data.Linq.Mapping.ParameterAttribute(Name="ID", DbType="Int")] System.Nullable<int> iD)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), iD);
			return ((ISingleResult<MetadataSchema>)(result.ReturnValue));
		}
    ...
    partial void OnDateCreatedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Object_Object_Object_Join", Storage="_Object_Object_Joins", ThisKey="GUID", OtherKey="Object1GUID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Object_Object_Object_Join1", Storage="_Object_Object_Joins1", ThisKey="GUID", OtherKey="Object2GUID")]
	...
	public partial class FolderInfo
	{
		...
		private System.Nullable<int> _NumberOfObjects;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NumberOfObjects", DbType="Int")]
		public System.Nullable<int> NumberOfObjects
		{
			get
			{
			...
			set
			{
				if ((this._NumberOfObjects != value))
				{
	...
	public partial class Object_Object_Join : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Guid _Object1GUID;
		
		private System.Guid _Object2GUID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnObject1GUIDChanging(System.Guid value);
    partial void OnObject1GUIDChanged();
    partial void OnObject2GUIDChanging(System.Guid value);
    ...
    partial void OnDateCreatedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Object1GUID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid Object1GUID
		{
			get
			{
				return this._Object1GUID;
			}
			set
			{
				if ((this._Object1GUID != value))
				{
					if (this._Object.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnObject1GUIDChanging(value);
					this.SendPropertyChanging();
					this._Object1GUID = value;
					this.SendPropertyChanged("Object1GUID");
					this.OnObject1GUIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Object2GUID", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid Object2GUID
		{
			get
			{
				return this._Object2GUID;
			}
			set
			{
				if ((this._Object2GUID != value))
				{
					if (this._Object1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnObject2GUIDChanging(value);
					this.SendPropertyChanging();
					this._Object2GUID = value;
					this.SendPropertyChanged("Object2GUID");
					this.OnObject2GUIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Object_Object_Object_Join", Storage="_Object", ThisKey="Object1GUID", OtherKey="GUID", IsForeignKey=true)]
		public Object Object
		{
			get
			{
			...
			set
			{
							...
							|| (this._Object.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._Object1GUID = value.GUID;
					}
					else
					{
						this._Object1GUID = default(System.Guid);
					}
					this.SendPropertyChanged("Object");
				}
			}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Object_Object_Object_Join1", Storage="_Object1", ThisKey="Object2GUID", OtherKey="GUID", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Object1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._Object2GUID = value.GUID;
					}
					else
					{
						this._Object2GUID = default(System.Guid);
					}
