...
namespace CHAOS.MCM.Data.Dto.Standard
{
	public class Object : Result, IIndexable
	{
		...
		public Object(Guid guid, uint objectTypeID, DateTime dateCreated, IEnumerable<Metadata> metadatas,
			IEnumerable<FileInfo> fileInfos, IEnumerable<Object_Object_Join> objectObjectJoins, IEnumerable<Link> folders,
			IEnumerable<AccessPoint_Object_Join> accessPoints)
		{
		...
		public Object()
			: this(
				Guid.Empty, uint.MinValue, DateTime.MinValue, new List<Metadata>(), new List<FileInfo>(),
				new List<Object_Object_Join>(), new List<Link>(), new List<AccessPoint_Object_Join>())
		{
		}
		...
		public IEnumerable<KeyValuePair<string, string>> GetIndexableFields()
		{
			...
			yield return
				new KeyValuePair<string, string>("DateCreated", DateCreated.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'"));
				...
				foreach (var metadata in Metadatas)
				{
					switch (metadata.MetadataSchemaGUID.ToString())
					{
						...
						case "e4ee26e4-94dc-d946-8e23-459c7de51fc0":
							if (metadata.MetadataXML.Descendants("TotalVotes").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("LB_TotalVotes", metadata.MetadataXML.Descendants("TotalVotes").First().Value)
									;
							break;
						case "f39ac380-e33d-7c4e-9ed9-7745990ed6c7":
							if (metadata.MetadataXML.Descendants("TotalVotes").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("HT_TotalVotes", metadata.MetadataXML.Descendants("TotalVotes").First().Value)
									;
							break;
						case "21453740-eb1a-8842-81b4-ec62975e89e0":
							if (metadata.MetadataXML.Descendants("Country").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("HT_Country_" + metadata.LanguageCode,
										metadata.MetadataXML.Descendants("Country").First().Value);
							break;
						...
						case "00000000-0000-0000-0000-000067c30000":
							...
							if (metadata.MetadataXML.Root.Attribute("created") != null)
								if (DateTime.TryParse(metadata.MetadataXML.Root.Attribute("created").Value, out dtTagCreated))
									yield return
										new KeyValuePair<string, string>("DKA-Crowd-Tag-Created_date",
											dtTagCreated.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'"));

							if (metadata.MetadataXML.Root.Attribute("status") != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Tag-Status_string",
										metadata.MetadataXML.Root.Attribute("status").Value);

							if (metadata.MetadataXML.Descendants(nsDKATag + "Tag").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Tag-Value_string",
										metadata.MetadataXML.Descendants(nsDKATag + "Tag").First().Value);
						...
						case "a37167e0-e13b-4d29-8a41-b0ffbaa1fe5f":
							...
							if (metadata.MetadataXML.Descendants(nsDKAC + "Views").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Views_int",
										metadata.MetadataXML.Descendants(nsDKAC + "Views").First().Value);
							else
							...
							if (metadata.MetadataXML.Descendants(nsDKAC + "Shares").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Shares_int",
										metadata.MetadataXML.Descendants(nsDKAC + "Shares").First().Value);
							else
							...
							if (metadata.MetadataXML.Descendants(nsDKAC + "Likes").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Likes_int",
										metadata.MetadataXML.Descendants(nsDKAC + "Likes").First().Value);
							else
							...
							if (metadata.MetadataXML.Descendants(nsDKAC + "Ratings").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Ratings_int",
										metadata.MetadataXML.Descendants(nsDKAC + "Ratings").First().Value);
							else
							...
							if (metadata.MetadataXML.Descendants(nsDKAC + "AccumulatedRate").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-AccumulatedRate_int",
										metadata.MetadataXML.Descendants(nsDKAC + "AccumulatedRate").First().Value);
							else
							...
							if (metadata.MetadataXML.Descendants(nsDKAC + "Slug").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-Slug_string",
										metadata.MetadataXML.Descendants(nsDKAC + "Slug").First().Value);

							// ShortSlug
							if (metadata.MetadataXML.Descendants(nsDKAC + "ShortSlug").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Crowd-ShortSlug_string",
										metadata.MetadataXML.Descendants(nsDKAC + "ShortSlug").First().Value);
						...
						case "5906a41b-feae-48db-bfb7-714b3e105396":
							...
							if (ns != null &&
							    metadata.MetadataXML.Descendants(XName.Get("ExternalIdentifier", ns.NamespaceName)).FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-ExternalIdentifier",
										metadata.MetadataXML.Descendants(XName.Get("ExternalIdentifier", ns.NamespaceName)).First().Value);
							else if (defaultNs != null &&
							         metadata.MetadataXML.Descendants(XName.Get("ExternalIdentifier", defaultNs.NamespaceName)).FirstOrDefault() !=
							         null)
								yield return
									new KeyValuePair<string, string>("DKA-ExternalIdentifier",
										metadata.MetadataXML.Descendants(XName.Get("ExternalIdentifier", defaultNs.NamespaceName)).First().Value);
							else if (metadata.MetadataXML.Descendants("ExternalIdentifier").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-ExternalIdentifier",
										metadata.MetadataXML.Descendants("ExternalIdentifier").First().Value);
							...
							if (metadata.MetadataXML.Descendants(defaultNs + "Organization").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Organization",
										metadata.MetadataXML.Descendants(defaultNs + "Organization").First().Value);
							else
								yield return
									new KeyValuePair<string, string>("DKA-Organization",
							...
							if (metadata.MetadataXML.Descendants(defaultNs + "Title").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Title_string",
										metadata.MetadataXML.Descendants(defaultNs + "Title").First().Value);
							else
								yield return
						...
						case "00000000-0000-0000-0000-000065c30000":
							...
							if (metadata.MetadataXML.Descendants(nsDKACollection + "Title").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Collection-Title_string",
										metadata.MetadataXML.Descendants(nsDKACollection + "Title").First().Value);

							if (metadata.MetadataXML.Descendants(nsDKACollection + "Type").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Collection-Type_string",
										metadata.MetadataXML.Descendants(nsDKACollection + "Type").First().Value);

							if (metadata.MetadataXML.Descendants(nsDKACollection + "Status").FirstOrDefault() != null)
								yield return
									new KeyValuePair<string, string>("DKA-Collection-Status_string",
										metadata.MetadataXML.Descendants(nsDKACollection + "Status").First().Value);
						...
						case "00000000-0000-0000-0000-000063c30000":
							...
							if (metadata.MetadataXML.Descendants("Organization").FirstOrDefault() != null && !DoDKA2Exist(Metadatas))
								yield return
									new KeyValuePair<string, string>("DKA-Organization",
										metadata.MetadataXML.Descendants("Organization").First().Value);
						...
						case "1fd4e56e-3f3a-4f25-ba3e-3d9f80d5d49e":
							if (metadata.MetadataXML.Root.Element("Name") != null)
								yield return
									new KeyValuePair<string, string>("CHAOS-Profile-Name", metadata.MetadataXML.Root.Element("Name").Value);
							break;
						...
						case "22c70550-90ce-43f9-9176-973c09760138":
							if (!string.IsNullOrEmpty(metadata.MetadataXML.Root.Element("FirstPublicationDate").Value))
								yield return new KeyValuePair<string, string>("FIATIFTA-ANP-FirstPublicationDate",
									DateTime.Parse(metadata.MetadataXML.Root.Element("FirstPublicationDate").Value)
										.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'"));

							if (!string.IsNullOrEmpty(metadata.MetadataXML.Root.Element("Title").Value))
								yield return
									new KeyValuePair<string, string>("FIATIFTA-ANP-Title", metadata.MetadataXML.Root.Element("Title").Value);

							if (!string.IsNullOrEmpty(metadata.MetadataXML.Root.Element("Publisher").Value))
								yield return
									new KeyValuePair<string, string>("FIATIFTA-ANP-Publisher", metadata.MetadataXML.Root.Element("Publisher").Value)
									;
							break;
						...
						case "00000000-0000-0000-0000-0000df820000":
							if (metadata.MetadataXML.Root.Element("PublicationDateTime") != null &&
							    metadata.MetadataXML.Root.Element("PublicationEndDateTime") != null)
							{
								...
								if (
									!DateTime.TryParseExact(larmPubStartDateString, dateTimeFormat1, formatProvider, DateTimeStyles.None,
										out larmPubStartDate) &&
									!DateTime.TryParseExact(larmPubStartDateString, dateTimeFormat2, formatProvider, DateTimeStyles.None,
										out larmPubStartDate) &&
									!DateTime.TryParseExact(larmPubStartDateString, dateTimeFormat3, formatProvider, DateTimeStyles.None,
										out larmPubStartDate) &&
									!DateTime.TryParseExact(larmPubStartDateString, dateTimeFormat4, formatProvider, DateTimeStyles.None,
										out larmPubStartDate) &&
									!DateTime.TryParseExact(larmPubStartDateString, dateTimeFormat5, formatProvider, DateTimeStyles.None,
										out larmPubStartDate))
									break;

								if (
									!DateTime.TryParseExact(larmPubEndDateString, dateTimeFormat1, formatProvider, DateTimeStyles.None,
										out larmPubEndDate) &&
									!DateTime.TryParseExact(larmPubEndDateString, dateTimeFormat2, formatProvider, DateTimeStyles.None,
										out larmPubEndDate) &&
									!DateTime.TryParseExact(larmPubEndDateString, dateTimeFormat3, formatProvider, DateTimeStyles.None,
										out larmPubEndDate) &&
									!DateTime.TryParseExact(larmPubEndDateString, dateTimeFormat4, formatProvider, DateTimeStyles.None,
										out larmPubEndDate) &&
									!DateTime.TryParseExact(larmPubEndDateString, dateTimeFormat5, formatProvider, DateTimeStyles.None,
										out larmPubEndDate))
									break;

								yield return
									new KeyValuePair<string, string>("LARM-PubStartDate",
										larmPubStartDate.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'", formatProvider));
								yield return
									new KeyValuePair<string, string>("LARM-PubEndDate",
										larmPubEndDate.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'", formatProvider));

								if (larmPubEndDate.CompareTo(larmPubStartDate) > 0)
									yield return
										new KeyValuePair<string, string>("LARM-Duration",
											((uint) larmPubEndDate.Subtract(larmPubStartDate).TotalSeconds).ToString());
								else
									yield return
										new KeyValuePair<string, string>("LARM-Duration",
											((uint) larmPubStartDate.Subtract(larmPubEndDate).TotalSeconds).ToString());

								yield return
									new KeyValuePair<string, string>("LARM-Annotation-Count",
										RelatedObjects.Count(item => item.ObjectTypeID == 41 || item.ObjectTypeID == 64).ToString());
							}
							...
							if (metadata.MetadataXML.Root.Element("PublicationChannel") != null)
								yield return
									new KeyValuePair<string, string>("LARM-Channel", metadata.MetadataXML.Root.Element("PublicationChannel").Value)
									;

							if (metadata.MetadataXML.Root.Element("Title") != null)
								yield return
									new KeyValuePair<string, string>("LARM-Title",
										metadata.MetadataXML.Root.Element("Title").Value.Trim().TrimStart('"').TrimEnd('"'));
							break;
						...
						case "70c26faf-b1ee-41e8-b916-a5a16b25ca69":
							if (metadata.MetadataXML.Root.Element("Date") != null)
								yield return
									new KeyValuePair<string, string>("LARM-PubStartDate",
										DateTime.Parse(metadata.MetadataXML.Root.Element("Date").Value).ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'"));
							if (metadata.MetadataXML.Root.Element("Title") != null)
						...
						case "a3a39145-4b30-4732-80a1-fb9214c53654":
							if (metadata.MetadataXML.Root.Element("ParsingValue") != null)
								yield return
									new KeyValuePair<string, string>("LARM-OCR-Report_float",
										metadata.MetadataXML.Root.Element("ParsingValue").Value.Replace(',', '.'));
						...
						case "bb615cd5-4470-ce4a-9207-b18e8ae33880":
							if (metadata.MetadataXML.Root.Element("sequenceIndex") != null)
								yield return
									new KeyValuePair<string, string>("KN-SequenceIndex", metadata.MetadataXML.Root.Element("sequenceIndex").Value);
							break;

						case "614c6ca6-1bb6-4c46-a37f-778b3e978d7e":
							if (metadata.MetadataXML.Root.Element("relationSequenceIndex") != null)
								yield return
									new KeyValuePair<string, string>("KN-relationSequenceIndex",
										metadata.MetadataXML.Root.Element("relationSequenceIndex").Value);
							break;
					...
					yield return
						new KeyValuePair<string, string>(
							string.Format("m{0}_{1}_all", metadata.MetadataSchemaGUID, metadata.LanguageCode),
							GetXmlContent(metadata.MetadataXML.Root));
				}
			...
			if (RelatedObjects != null)
			{
				foreach (var obj in RelatedObjects)
				{
					foreach (var relatedMetadata in obj.Metadatas)
					{
						yield return
							new KeyValuePair<string, string>(
								string.Format("rm{0}_{1}_all", relatedMetadata.MetadataSchemaGUID, relatedMetadata.LanguageCode),
								GetXmlContent(relatedMetadata.MetadataXML.Root));
					}
				}
			}
			...
			if (AccessPoints != null)
				foreach (var ap in AccessPoints)
				{
					...
					yield return
						new KeyValuePair<string, string>(string.Format("ap{0}_PubStart", ap.AccessPointGUID),
							start.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss'Z'"));
					yield return
						new KeyValuePair<string, string>(string.Format("ap{0}_PubEnd", ap.AccessPointGUID),
		...
		{
			return
				metadatas.Any(metadata => metadata.MetadataSchemaGUID.ToString().ToLower() == "5906a41b-feae-48db-bfb7-714b3e105396");
		}
